...
SELECT Name, SurfaceArea, Population, (Population/SurfaceArea) AS "Ratio" FROM country WHERE Population/SurfaceArea != 0 ORDER BY Population/SurfaceArea LIMIT 10;
